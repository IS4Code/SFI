...
namespace IS4.SFI.Analyzers
{
    ...
    public class PropertyAnalyzer : MemberAnalyzer<PropertyInfo>
    {
        ...
        /// <inheritdoc/>
        protected async override ValueTask<AnalysisResult> AnalyzeDefinition(PropertyInfo member, ILinkedNode node, AnalysisContext context, IEntityAnalyzers analyzers)
        {
