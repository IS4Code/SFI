...
namespace IS4.SFI.Vocabulary
{
    ...
    public struct GraphUri : ITermUri, IEquatable<GraphUri>
    {
        ...
        /// <summary>
        /// Compares two instances of <see cref="GraphUri"/> for equality.
        /// </summary>
        /// <param name="a">The first instance to compare.</param>
        /// <param name="b">The second instance to compare.</param>
        /// <returns>The result of <see cref="Equals(GraphUri)"/>.</returns>
        ...
        /// <summary>
        /// Compares two instances of <see cref="GraphUri"/> for inequality.
        /// </summary>
        /// <param name="a">The first instance to compare.</param>
        /// <param name="b">The second instance to compare.</param>
        /// <returns>The negated result of <see cref="Equals(GraphUri)"/>.</returns>
        public static bool operator !=(GraphUri a, GraphUri b)
        {
            return !a.Equals(b);
        }
