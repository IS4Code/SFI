...
namespace IS4.MultiArchiver.Formats
{
    ...
    public class CabinetFormat : SignatureFormat<CabinetFile>
    {
        ...
        public async override ValueTask<TResult> Match<TResult, TArgs>(Stream stream, MatchContext context, ResultFactory<CabinetFile, TResult, TArgs> resultFactory, TArgs args)
        {
